...
def get_full_pipeline():
    ...
    # This step is done as a column transformation before the pipeline for simplicity
...
def main():
    ...
    try:
        ...
        # Build and fit the full pipeline once
        pipeline = get_full_pipeline()
        pipeline_model = pipeline.fit(train_df)
        
        # **NEW**: Save the fitted preprocessing pipeline model for deployment
        pipeline_model.write().overwrite().save("./preprocessing_pipeline_model")
